...
import com.crunchynoodles.eri.block.interfaces.CtcSignalMastItem;
...
public class BlocksModel {
    ...
    protected BlocksModel( BlocksModel baseline )
    {
        this();
     ...
     */
    public BlocksModel startTransaction()
    {
        BlocksModel  trx = new BlocksModel( this );
    ...
    protected BlocksModel   m_baseline_model;
